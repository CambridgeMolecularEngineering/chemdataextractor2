...
class TestTable(unittest.TestCase):
    ...
    def test_model_updating_from_caption_1(self):
        ...
        expected = [
            ...
            {'CurieTemperature': {'raw_value': 'NoValue', 'raw_units': 'K', 'units': 'Kelvin^(1.0)', 'specifier': 'TD', 'compound': {'Compound': {'names': ['PrMnO3']}}}},
            {'CurieTemperature': {'raw_value': '116.5', 'raw_units': 'K', 'value': [116.5], 'units': 'Kelvin^(1.0)', 'specifier': 'TD', 'compound': {'Compound': {'names': ['PrMnO3']}}}},
            {'NeelTemperature': {'raw_value': 'NoValue', 'raw_units': 'K', 'units': 'Kelvin^(1.0)', 'specifier': 'TN', 'compound': {'Compound': {'names': ['PrMnO3']}}}},
