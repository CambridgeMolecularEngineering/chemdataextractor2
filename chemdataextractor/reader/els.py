...
from ..scrape.pub.els import elsevier_substitute
...
strip_els_xml = CleanerEls(strip_xpath='.//ce:inf | .//ce:italic | .//ce:sup')
...
class ElsXmlReader(XmlReader):
    """Reader for Elsevier XML documents."""

    cleaners = [clean, els_xml_whitespace, strip_els_xml]
